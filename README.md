...
### 升级到 release-20260618 版本（镜像发布时间 2026.6.18）

拉取并重启最新镜像后，需重新下载本仓库提供的 20260618版本客户端并完成[登录器设置](#第四步配置客户端)。

注意，此版本服务端变化较大，自定义脚本等文件将被备份到相同目录中，请自行确认是否需要调整以适配新版镜像。未修改过容器自带脚本的用户可忽略此提示。
